...
public class UserController {
     ...
     */
//    @RequestMapping(params = {"name", "age", "email"}, method = RequestMethod.POST)
//    public ResponseEntity<User> createUser(@RequestParam("name") String name, @RequestParam("age") int age, @RequestParam("email") String email){
//        return new ResponseEntity<>(this.userService.createUser(name, age, email), HttpStatus.CREATED);
//    }
